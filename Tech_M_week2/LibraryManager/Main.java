...
public class Main {
	public static void main(String[] args) {
		...
		// Adding Sample Books
		Book book1 = new Book();
		book1.setBookTitle("let us be strangers");
		book1.setAuthor("lee don");
		book1.setIsbnNumber("2451");
		libraryManager.addBook(book1);

		Book book2 = new Book();
		book2.setBookTitle("let us explore");
		book2.setAuthor("stephen");
		book2.setIsbnNumber("5421");
